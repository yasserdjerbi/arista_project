...
class AccountMove(models.Model):
    ...
    def _stock_account_prepare_anglo_saxon_in_lines_vals(self):
        ''' We Override this method to consider cost_method lot. But we can't super as the injection is inside the method. And for now no other module overriding this method
        '''
        lines_vals_list = []
        ...
        for move in self:
            ...
            for line in move.invoice_line_ids.filtered(lambda line: line.product_id.type == 'product' and line.product_id.valuation == 'real_time'):
                ...
                if line.product_id.cost_method != 'standard' and line.purchase_line_id:
                    ...
                    elif line.product_id.cost_method in ('fifo', 'lot'):
